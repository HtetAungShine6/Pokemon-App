...
struct PokemonDetailView: View {
    ...
    var body: some View {
        ...
        ZStack {
            LinearGradient(gradient: Gradient(colors: [Color(viewModel.backgroundColor(forType: pokemon.type)).opacity(0.6), Color(viewModel.backgroundColor(forType: pokemon.type)).opacity(0.2)]), startPoint: .center, endPoint: .bottomTrailing)
